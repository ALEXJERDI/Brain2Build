...
public class ProjectController {
    ...
    // 🔹 CREATE – Créer un projet (et créer automatiquement son Room)
    @PostMapping
    public ResponseEntity<ProjectReadDto> createProject(@RequestBody @Validated ProjectCreateUpdateDto dto) {
    ...
    // 🔹 UPDATE STATUS – Modifier uniquement le statut (IN_PROGRESS, COMPLETED, ARCHIVED)
    ...
    // 🔹 DELETE – Supprimer un projet et son Room associé
    @DeleteMapping("/{id}")
